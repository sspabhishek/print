	...
	<script>
		window.addEventListener('load', function () {
			...
			jQuery("#shiprocket_get_account_details").click(function () {
				...
				data.billing_address = "<?php echo $user_meta['billing_address_1'][0] ? esc_html( $user_meta['billing_address_1'][0] ) : ''; ?>";
				data.billing_address_2 = "<?php echo $user_meta['billing_address_2'][0] ? esc_html( $user_meta['billing_address_2'][0] ) : ''; ?>";
				data.billing_city = "<?php echo $user_meta['billing_city'][0] ? esc_html( $user_meta['billing_city'][0] ) : ''; ?>";
				data.billing_state = "<?php echo $user_meta['billing_state'][0] ? esc_html( $user_meta['billing_state'][0] ) : ''; ?>";
				data.billing_country = "<?php echo $user_meta['billing_country'][0] ? esc_html( $user_meta['billing_country'][0] ) : ''; ?>";
				data.billing_pin_code = "<?php echo $user_meta['billing_postcode'][0] ? esc_html( $user_meta['billing_postcode'][0] ) : ''; ?>";
				data.billing_phone = "<?php echo $user_meta['billing_phone'][0] ? esc_html( $user_meta['billing_phone'][0] ) : ''; ?>";
				data.shipping_address = "<?php echo $user_meta['shipping_address_1'][0] ? esc_html( $user_meta['shipping_address_1'][0] ) : ''; ?>";
				<?php ob_start(); ?>
				data.shipping_address_2 = "<?php echo $user_meta['shipping_address_2'][0] ? esc_html( $user_meta['shipping_address_2'][0] ) : ''; ?>";
				data.shipping_city = "<?php echo $user_meta['shipping_city'][0] ? esc_html( $user_meta['shipping_city'][0] ) : ''; ?>";
				data.shipping_state = "<?php echo $user_meta['shipping_state'][0] ? esc_html( $user_meta['shipping_state'][0] ) : ''; ?>";
				data.shipping_country = "<?php echo $user_meta['shipping_country'][0] ? esc_html( $user_meta['shipping_country'][0] ) : ''; ?>";
				data.shipping_pin_code = "<?php echo $user_meta['shipping_postcode'][0] ? esc_html( $user_meta['shipping_postcode'][0] ) : ''; ?>";
				data.shipping_phone = "<?php echo $user_meta['shipping_phone'][0] ? esc_html( $user_meta['shipping_phone'][0] ) : ''; ?>";
